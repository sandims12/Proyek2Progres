<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
            <a href="#">
                <i class="fa fa-cart-arrow-down"></i> <span>Pengeluaran</span>
              </a>
        </li>
        <li>
            <a href="#">
        ...
        <li>
            <a href="#">
                <i class="fa fa-line-chart"></i> <span>Transaksi Lama</span>
              </a>
        </li>
        <li>
            <a href="#">
                <i class="fa fa-pie-chart"></i> <span>Transaksi Baru</span>
              </a>
        </li>
